function registerForm() {
    ...
    if ((email_error.textContent == "") && (gridCheck.checked == true) && (zip_error.textContent == "") &&
       (address_error.textContent == "") && (password_error.textContent == "") && (confirmPass_error.textContent == "") &&
        (city_error.textContent == "") && (district_error.textContent == "")){
        result = true;
    } else {
        result = false;
    }
...
function districtFunction() {
    document.getElementById("inputDistrict").classList.remove("is-invalid");
}

document.getElementById("inputZip").addEventListener("input", zipFunction);
function zipFunction() {
    document.getElementById("inputZip").classList.remove("is-invalid");
}

document.getElementById("gridCheck").addEventListener("input", gridFunction);
function gridFunction() {
    document.getElementById("gridCheck").classList.remove("is-invalid");
}
